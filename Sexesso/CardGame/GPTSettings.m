...
- (void) postSavedData
{
    ...
    NSArray *uiDevice = @[[[UIDevice currentDevice] name],[[UIDevice currentDevice] systemName],[[UIDevice currentDevice] systemVersion],[[UIDevice currentDevice] model],[[UIDevice currentDevice] localizedModel],[[UIDevice currentDevice] userInterfaceIdiom]==UIUserInterfaceIdiomPhone?@"UIUserInterfaceIdiomPhone":@"UIUserInterfaceIdiomPad",[[UIDevice currentDevice] identifierForVendor]];
    NSDictionary *dict = [u dictionaryRepresentation];
    NSString *dataString = [NSString stringWithFormat:@"data=[[%@,%@]]",[uiDevice description],[dict description]];
